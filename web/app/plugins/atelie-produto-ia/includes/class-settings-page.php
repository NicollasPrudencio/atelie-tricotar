...
class Atelie_Settings_Page {
	...
	public function registrar(): void {
		...
		add_action( 'admin_post_atelie_salvar_config_ia', array( $this, 'salvar' ) );
		add_action( 'admin_post_atelie_testar_conexao_ia', array( $this, 'testar' ) );
		add_action( 'admin_post_atelie_salvar_custos_ia', array( $this, 'salvar_custos' ) );
	}
