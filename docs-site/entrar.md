...
- **Produtos** (menu nativo do WooCommerce) — além da listagem de produtos, tem **"Novo
  Produto"** e **"Pendências"** (ver [Cadastrar produto novo](/novo-produto/) e
...
Em qualquer tela do painel, procure o botão **"?"** no canto — ele abre um painel com dicas
rápidas daquela tela específica, sem precisar sair de onde você está.
