...
Se você é Vendedora, pode ir direto para [Como entrar no painel](/entrar/) e depois para
[Cadastrar produto novo](/novo-produto/). As páginas na seção "Só para quem administra" não vão
aparecer no seu menu — é normal, não é erro.

## Por onde começar

- [Como entrar no painel](/entrar/)
- [Cadastrar produto novo](/novo-produto/)
...
> Este é um manual vivo, atualizado a cada funcionalidade nova do painel.
